...
#endif
uniform float2 cFrameUpPS;
uniform float2 cFrameRightPS;
uniform float4 cFrameSizeInvSizePS;
uniform float2 cFrameAspectRatio;
#endif
...
cbuffer CameraPS : register(b1)
{
    ...
    float cFarClipPS;
    float2 cFrameUpPS;
    float2 cFrameRightPS;
    float4 cFrameSizeInvSizePS;  
    float2 cFrameAspectRatio;
}
